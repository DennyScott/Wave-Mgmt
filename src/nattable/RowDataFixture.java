 ...
 *    ******************************************************************************/
import static nattable.RowDataListFixture.PRICING_MANUAL;
...
public class RowDataFixture {	
	...
	public static final IRowIdAccessor<RowDataFixture> rowIdAccessor = new IRowIdAccessor<RowDataFixture>() {
		...
		public RowDataFixture(	String security_id,String security_description,String rating,Date issue_date,PricingTypeBean pricing_type,
				double bid_price,double ask_price,	int lot_size,	boolean publish_flag,double high52Week,double low52Week,
		...
		public static RowDataFixture getInstance(String descrition, String rating) {
			return new RowDataFixture("US978", descrition, rating, getRandomDate(), PRICING_MANUAL,1.000, 10, 1000, true, 1.00, 1.01, -.01, 1000, 1000, 1000D);	
		}	
		@Override
